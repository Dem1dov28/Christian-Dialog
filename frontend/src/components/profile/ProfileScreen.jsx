                  ...
                  {isPrivacyItem && (
                    ...
                    >
                      <div className="divide-y divide-[var(--border-color)]">
                        ...
                        {/* Linked accounts — привязка и отвязка Google и Telegram */}
                        ...
                        {/* Приглашение привязать Google (если ещё не привязан) */}
                        {!user?.google_id && googleClientId && (
                          <div className="p-4 border-t border-[var(--border-color)] rounded-lg bg-white/5 border-white/10">
                            <div className="flex items-start gap-3">
                              ...
                              <div className="min-w-0 flex-1">
                                ...
                                <p className="text-sm text-[var(--text-dim)] mb-3">
                                  {language === "ru"
                                    ? "Войдите через Google, чтобы привязать аккаунт и использовать его для входа."
                                    : "Sign in with Google to link your account and use it for login."}
                                </p>
